...
bool Window::mouseInEdgePanArea(const sf::Event::MouseMoveEvent& mousePosition)
{
    mouseInEdgePanArea(sf::Vector2i(mousePosition.x, mousePosition.y));
}

bool Window::mouseInEdgePanArea(const sf::Vector2i& mousePosition)
{
